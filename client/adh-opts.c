...
int ov_tcp=0, ov_cname=0, ov_afflags=adns_qf_ipv6_ok, ov_format=fmt_default;
char *ov_id= 0;
...
static const struct optioninfo perquery_options[]= {
  ...
  { ot_value,		 "Only return IPv4 addresses",
    "A4", "--addr-ipv4-only", &ov_afflags, adns_qf_ipv4_only },
  { ot_value,		 "Return all available addresses (default)",
    "Aa", "--addr-all",	   &ov_afflags, adns_qf_ipv6_ok },
  { ot_value,		 "Only return IPv6 addresses",
    "A6", "--addr-ipv6-only", &ov_afflags, adns_qf_ipv6_only },
  { ot_value,		 "Return IPv4 addresses as IPv6-mapped",
    "Am", "--addr-ipv6-mapped", &ov_afflags, adns_qf_ipv6_mapv4 },
